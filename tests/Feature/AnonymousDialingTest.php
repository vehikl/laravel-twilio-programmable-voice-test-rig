...
class AnonymousDialingTest extends TestCase
{
    ...
    public function itCanGatherDigitsAndMakeAPhoneCall(): void
    {
        (new ProgrammableVoiceRig(
            ...
            ->assertSaid('Dial North-American Number, then press pound')
...
//            ->assertTwimlContains('<Redirect method="POST">%s</Redirect>', route('anonymous-dialing.failed'))
            ...
            ->assertTwilioRedirectedTo(route('anonymous-dialing.dial'), byTwimlTag: "Gather")
            ->assertSaid('Dialing 5 5 5 4 4 4 3 3 2 2, please wait')
            ->assertPaused(1)
            ...
            ->assertTwilioRedirectedTo(route('anonymous-dialing.completed'), byTwimlTag: 'Dial')
            ->assertSaid('Phone call completed')
//            ->assertHungUp()
            ->assertCallEnded();
    }
}
